...
export class EditUserReputationActionBase implements Action<User> {
  ...
  static create<T extends EditUserReputationActionBase>(
  ...
  static async saveXFromID<T extends EditUserReputationActionBase>(
    this: new (viewer: Viewer, user: User, input: UserEditInput) => T,
    viewer: Viewer,
    id: ID,
    input: UserEditInput,
