...
export const answerCommentToAuthorsCountLoaderFactory =
  new AssocEdgeCountLoaderFactory(EdgeType.AnswerCommentToAuthors);
export const answerCommentToAuthorsDataLoaderFactory =
  new AssocEdgeLoaderFactory(
    EdgeType.AnswerCommentToAuthors,
    () => AnswerCommentToAuthorsEdge,
  );

export class AnswerCommentToAuthorsQueryBase extends AssocEdgeQueryBase<
  AnswerComment,
  User,
  AnswerCommentToAuthorsEdge
> {
  constructor(viewer: Viewer, src: EdgeQuerySource<AnswerComment>) {
    super(
      viewer,
      src,
      answerCommentToAuthorsCountLoaderFactory,
      answerCommentToAuthorsDataLoaderFactory,
      User.loaderOptions(),
    );
  }

  static query<T extends AnswerCommentToAuthorsQueryBase>(
    this: new (viewer: Viewer, src: EdgeQuerySource<AnswerComment>) => T,
    viewer: Viewer,
    src: EdgeQuerySource<AnswerComment>,
  ): T {
